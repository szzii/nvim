...
vim.keymap.set('', 'S', ':w<CR>', { noremap = true, silent = true })
vim.keymap.set('', 'Q', ':q<CR>', { noremap = true, silent = true })
vim.keymap.set({ 'n', 'x' }, '<TAB>', '>>', { noremap = false })
vim.keymap.set({ 'n', 'x' }, '<S-TAB>', '<<', { noremap = false })
